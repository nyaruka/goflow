...
To render a URN in a human friendly format, use the [format_urn](context.html#function:format_urn) function.
...
It is the inverse of [code](context.html#function:code).
...
It is the inverse of [char](context.html#function:char).
