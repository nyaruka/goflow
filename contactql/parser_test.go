...
func TestParseAndValidateQuery(t *testing.T) {
	tests := []struct {
		...
		{`tickets = 0`, `tickets = 0`, "", envs.RedactionPolicyNone},
		...
		{`tickets = ""`, ``, "can't check whether 'tickets' is set or not set", envs.RedactionPolicyNone},
		...
		{`tickets ~ 12`, ``, "contains conditions can only be used with name or URN values", envs.RedactionPolicyNone},
