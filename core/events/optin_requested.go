...
func init() {
	registerType(TypeOptInRequested, func() Event { return &OptInRequested{} })
}
...
func NewOptInRequested(optIn *assets.OptInReference, ch *assets.ChannelReference, urn urns.URN) *OptInRequested {
