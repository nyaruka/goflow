...
func init() {
	registerType(TypeCampaignFired, func() Event { return &CampaignFired{} })
}
...
func NewCampaignFired(campaign *assets.CampaignReference, pointUUID assets.CampaignPointUUID) *CampaignFired {
