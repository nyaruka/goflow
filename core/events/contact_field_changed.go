...
func init() {
	registerType(TypeContactFieldChanged, func() Event { return &ContactFieldChanged{} })
}
...
// ContactFieldChanged events are created when a field value of the contact has been changed. A null value indicates
