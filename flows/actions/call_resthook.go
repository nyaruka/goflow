...
func init() {
	registerType(TypeCallResthook, func() flows.Action { return &CallResthook{} })
}
...
func NewCallResthook(uuid flows.ActionUUID, resthook string, resultName string) *CallResthook {
	return &CallResthook{
...
func (a *CallResthook) Execute(ctx context.Context, run flows.Run, step flows.Step, logModifier flows.ModifierCallback, logEvent flows.EventCallback) error {
...
func (a *CallResthook) pickResultCall(calls []*httpx.Trace) *httpx.Trace {
...
func (a *CallResthook) Inspect(dependency func(assets.Reference), local func(string), result func(*flows.ResultInfo)) {
	if a.ResultName != "" {
