...
// ResultInfo describes the result generated by this flow object
func (a *SetRunResultAction) ResultInfo(node flows.Node) *flows.ResultInfo {
	if a.Category != "" {
		return flows.NewResultInfo(a.Name, []string{a.Category}, node)
	}
	return flows.NewResultInfo(a.Name, []string{}, node)
}
