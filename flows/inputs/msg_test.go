...
func TestMsgInput(t *testing.T) {
	...
	assert.Equal(t, string(msgEvt.UUID()), string(input.UUID()))
	...
	assert.Equal(t, `{"type":"msg","uuid":"01969b47-672b-76f8-acca-bbca70987315","channel":{"uuid":"57f1078f-88aa-46f4-a59a-948a5739c03d","name":"My Android Phone"},"created_on":"2025-05-04T12:31:11.123456789Z","urn":"tel:+1234567890","text":"Hi there!","attachments":["image/jpg:http://example.com/test.jpg","video/mp4:http://example.com/test.mp4"],"external_id":"ext12345"}`, string(marshaled))
}
