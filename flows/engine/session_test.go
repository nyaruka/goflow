...
func TestContextToJSON(t *testing.T) {
	tests := []struct {
		...
		{"parent", `{"contact":{"channel":null,"created_on":"0001-01-01T00:00:00.000000Z","fields":{"age":33,"gender":"Female"},"groups":[],"language":"spa","name":"Jasmine","timezone":null,"urns":[],"uuid":"c59b0033-e748-4240-9d4c-e85eb6800151"},"flow":{"name":"Parent","revision":0,"uuid":"fece6eac-9127-4343-9269-56e88f391562"},"results":{"role":{"category":"Reporter","category_localized":"Reporter","created_on":"2000-01-01T00:00:00.000000Z","input":"a reporter","name":"Role","node_uuid":"385cb848-5043-448e-9123-05cbcf26ad74","value":"reporter"}},"status":"active","uuid":"4213ac47-93fd-48c4-af12-7da8218ef09d"}`},
