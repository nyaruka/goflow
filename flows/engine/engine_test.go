...
func TestBuilder(t *testing.T) {
	...
	eng = engine.NewBuilder().
		WithWebhookServiceFactory(func() (flows.WebhookService, error) { return webhookSvc, nil }).
		Build()

	svc, err := eng.Services().Webhook()
