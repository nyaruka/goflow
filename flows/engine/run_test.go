...
func TestRuns(t *testing.T) {
	...
	checkRuns := func(s flows.Session) {
		...
		assert.Equal(t, events.RunUUID("01969b47-113b-76f8-9c0b-2014ddc77094"), r1.UUID())
		assert.Equal(t, events.RunStatusCompleted, r1.Status())
		...
		assert.Equal(t, events.RunUUID("01969b47-24c3-76f8-8f41-6b2d9f33d623"), r2.UUID())
		assert.Equal(t, events.RunUUID("01969b47-113b-76f8-9c0b-2014ddc77094"), r2.Parent().UUID())
	}
...
func TestSetResult(t *testing.T) {
	...
	prev, changed := run.SetResult(events.NewResult("Response 1", "red", "Red", "Rojo", "6d35528e-cae3-4e30-b842-8fe6ed7d5c02", "I like red", nil, dates.Now()))
	assert.Nil(t, prev)
	...
	prev, changed = run.SetResult(events.NewResult("Response 1", "blue", "Blue", "Azul", "6d35528e-cae3-4e30-b842-8fe6ed7d5c02", "I like blue", nil, dates.Now()))
	...
	prev, changed = run.SetResult(events.NewResult("Response 1", "blue", "Blue", "Azul", "6f53c6ae-b66e-44dc-af9e-638e26ad05e9", "blue", nil, dates.Now()))
	assert.Nil(t, prev)
	assert.False(t, changed)

	// long values should truncated
	prev, changed = run.SetResult(events.NewResult("Response 1", strings.Repeat("創", 700), "Blue", "Azul", "6d35528e-cae3-4e30-b842-8fe6ed7d5c02", "I like blue", nil, dates.Now()))
...
func TestTranslation(t *testing.T) {
	...
	tcs := []struct {
		...
		expectedQuickReplies []events.QuickReply
	}{
		{
			...
			expectedQuickReplies: []events.QuickReply{{Type: "text", Text: "yes"}, {Type: "text", Text: "no"}},
		},
		{
			...
			expectedQuickReplies: []events.QuickReply{{Type: "text", Text: "si"}},
		},
		{
