...
var testTests = []struct {
	...
	// has_intent and has_top_intent are deprecated and always return false
	{"has_intent", dmy, []types.XValue{xj(`{}`), xs("book_flight"), xn("0.5")}, falseResult},
	{"has_top_intent", dmy, []types.XValue{xj(`{}`), xs("book_flight"), xn("0.5")}, falseResult},
}
...
func TestHasPhone(t *testing.T) {
	tests := []struct {
		...
		{"+12065550100", "RW", "+12065550100"}, // if num has country code, doesn't need to match test country
		{"12065550100", "US", "+12065550100"},
		{"206 555 0100", "US", "+12065550100"},
