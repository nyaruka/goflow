...
func TestURNShortcuts(t *testing.T) {
	...
	assert.Equal(t, types.NewXText("0781 234 567"), urnCuts.Resolve(env, "display"))
	...
	assert.Equal(t, types.NewXText(`{"display":"0781 234 567","path":"+250781234567","scheme":"tel"}`), urnCuts.ToXJSON(env))
}
