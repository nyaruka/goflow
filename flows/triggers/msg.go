...
func (t *MsgTrigger) InitializeRun(run flows.FlowRun, log func(flows.Event)) error {
	// update our input
	...
	log(events.NewMsgReceivedEvent(t.msg))

	return t.baseTrigger.InitializeRun(run, log)
}
