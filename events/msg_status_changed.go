...
func init() {
	registerType(TypeMsgStatusChanged, func() Event { return &MsgStatusChanged{} })
}
...
func NewMsgStatusChanged(msgUUID EventUUID, status string, reason string) *MsgStatusChanged {
...
var _ Event = (*MsgStatusChanged)(nil)
