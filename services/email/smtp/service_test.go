...
func TestService(t *testing.T) {
	...
	err = svc.Send(t.Context(), []string{"bob@nyaruka.com", "jim@nyaruka.com"}, "Updates", "Have a great week")
	...
	err = svc.Send(t.Context(), []string{"bob@nyaruka.com", "jim@nyaruka.com"}, "Updates", " ")
