...
func TestSendMessage(t *testing.T) {
	...
	_, _, err := client.SendMessage("Bob <thread+12446@mr.nyaruka.com>", "support@acme.com", "Need help", "Where are my cookies?")
	...
	msgID, trace, err := client.SendMessage("Bob <thread+12446@mr.nyaruka.com>", "support@acme.com", "Need help", "Where are my cookies?")
