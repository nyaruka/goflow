...
func TestSendMessage(t *testing.T) {
	...
	httpx.SetRequestor(httpx.NewMockRequestor(map[string][]httpx.MockResponse{
		"https://api.mailgun.net/v3/mr.nyaruka.com/messages": {
			httpx.NewMockResponse(200, nil, `"{"message":"Queued. Thank you."}`),
		},
	}))
	...
	trace, err := client.SendMessage("Bob <thread+12446@mr.nyaruka.com>", "support@acme.com", "Need help", "Where are my cookies?")
	...
	assert.Equal(t, "\"{\"message\":\"Queued. Thank you.\"}", string(trace.ResponseBody))
}
