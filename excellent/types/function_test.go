...
func TestXFunction(t *testing.T) {
	...
	anon1 := types.NewXFunction("", func(env envs.Environment, args ...types.XValue) types.XValue { return nil })
	anon2 := types.NewXFunction("", func(env envs.Environment, args ...types.XValue) types.XValue { return nil })
