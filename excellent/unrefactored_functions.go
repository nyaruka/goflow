...
// Function defines the interface that Excellent functions must implement
type Function func(env utils.Environment, args ...interface{}) interface{}
...
// FUNCTIONS is our map of functions available in Excellent which aren't tests
var FUNCTIONS = map[string]Function{
	...
	"title":             _Title,
	"word":              _Word,
	"remove_first_word": _RemoveFirstWord,
	"word_count":        _WordCount,
	"word_slice":        _WordSlice,
	"field":             _Field,
	"clean":             _Clean,
	"left":              _Left,
	"lower":             _Lower,
	"right":             _Right,
	"string_cmp":        _StringCmp,
	"repeat":            _Repeat,
	"replace":           _Replace,
	"upper":             _Upper,
	"percent":           _Percent,
	...
	"parse_date":      _ParseDate,
	"date":            _Date,
	"date_from_parts": _DateFromParts,
	"date_diff":       _DateDiff,
	"date_add":        _DateAdd,
	"weekday":         _Weekday,
	"tz":              _TZ,
	...
	"today":           _Today,
	"now":             _Now,
	"from_epoch":      _FromEpoch,
	"to_epoch":        _ToEpoch,

	"format_urn": _FormatURN,
}
...
func _LegacyAdd(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 2 {
...
func _Length(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 1 {
...
func _Default(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 2 {
...
func _Array(env utils.Environment, args ...interface{}) interface{} {
...
func _FromJSON(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 1 {
...
func _ToJSON(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 1 {
...
func _URLEncode(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 1 {
...
//
// @function and(tests...)
func _And(env utils.Environment, args ...interface{}) interface{} {
	if len(args) == 0 {
...
//
// @function or(tests...)
func _Or(env utils.Environment, args ...interface{}) interface{} {
	if len(args) == 0 {
...
func _If(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 3 {
...
//
// @function abs(num)
func _Abs(env utils.Environment, args ...interface{}) interface{} {
	dec, err := _checkOneDecimalArg(env, "ABS", args)
	if err != nil {
		return err
	}
	return dec.Abs()
...
func _Round(env utils.Environment, args ...interface{}) interface{} {
...
func _RoundUp(env utils.Environment, args ...interface{}) interface{} {
	dec, err := _checkOneDecimalArg(env, "ROUND_UP", args)
	if err != nil {
		return err
	}
...
func _RoundDown(env utils.Environment, args ...interface{}) interface{} {
	dec, err := _checkOneDecimalArg(env, "ROUND_DOWN", args)
	if err != nil {
		return err
	}
...
//
// @function max(values...)
func _Max(env utils.Environment, args ...interface{}) interface{} {
	if len(args) == 0 {
...
//
// @function min(values)
func _Min(env utils.Environment, args ...interface{}) interface{} {
	if len(args) == 0 {
...
func _Mean(env utils.Environment, args ...interface{}) interface{} {
	if len(args) == 0 {
...
func _Mod(env utils.Environment, args ...interface{}) interface{} {
	arg1, arg2, err := _checkTwoDecimalArgs(env, "MOD", args)
	if err != nil {
		return err
	}
...
var _randSource = rand.NewSource(time.Now().UnixNano())
...
func _Rand(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 0 && len(args) != 2 {
		return fmt.Errorf("RAND takes either no arguments or two arguments, got %d", len(args))
	}

	if len(args) == 0 {
		return decimal.NewFromFloat(rand.New(_randSource).Float64())
	}
...
func _FormatNum(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 3 {
...
func _ReadCode(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 1 {
...
func _Code(env utils.Environment, args ...interface{}) interface{} {
	str, err := _checkOneStringArg(env, "code", args)
	if err != nil {
		return err
	}
...
func _Split(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 2 {
...
func _Join(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 2 {
...
//
// @function char(num)
func _Char(env utils.Environment, args ...interface{}) interface{} {
	arg, err := _checkOneDecimalArg(env, "CHAR", args)
	if err != nil {
		return err
	}
...
func _Title(env utils.Environment, args ...interface{}) interface{} {
	arg, err := _checkOneStringArg(env, "TITLE", args)
	if err != nil {
		return err
	}
...
func _Word(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 2 {
...
func _RemoveFirstWord(env utils.Environment, args ...interface{}) interface{} {
	arg, err := _checkOneStringArg(env, "REMOVE_FIRST_WORD", args)
	if err != nil {
		return err
	}
...
func _WordSlice(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 3 {
...
func _WordCount(env utils.Environment, args ...interface{}) interface{} {
	arg, err := _checkOneStringArg(env, "WORD_COUNT", args)
	if err != nil {
		return err
	}
...
func _Field(env utils.Environment, args ...interface{}) interface{} {
...
func _Clean(env utils.Environment, args ...interface{}) interface{} {
	arg, err := _checkOneStringArg(env, "CLEAN", args)
	if err != nil {
		return err
	}
...
func _Left(env utils.Environment, args ...interface{}) interface{} {
	str, l, err := _checkOneStringOneIntArg(env, "LEFT", args)
	if err != nil {
		return err
	}
...
func _Lower(env utils.Environment, args ...interface{}) interface{} {
	arg, err := _checkOneStringArg(env, "LOWER", args)
	if err != nil {
		return err
	}
...
func _Right(env utils.Environment, args ...interface{}) interface{} {
	str, l, err := _checkOneStringOneIntArg(env, "RIGHT", args)
	if err != nil {
		return err
	}
...
func _StringCmp(env utils.Environment, args ...interface{}) interface{} {
	str1, str2, err := _checkTwoStringArgs(env, "STRING_CMP", args)
	if err != nil {
		return err
	}
...
func _Repeat(env utils.Environment, args ...interface{}) interface{} {
	str, i, err := _checkOneStringOneIntArg(env, "REPEAT", args)
	if err != nil {
		return err
	}
...
func _Replace(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 3 {
...
func _Upper(env utils.Environment, args ...interface{}) interface{} {
	str, err := _checkOneStringArg(env, "UPPER", args)
	if err != nil {
		return err
	}
...
func _Percent(env utils.Environment, args ...interface{}) interface{} {
	dec, err := _checkOneDecimalArg(env, "PERCENT", args)
	if err != nil {
		return err
	}
...
func _ParseDate(env utils.Environment, args ...interface{}) interface{} {
...
func _FormatDate(env utils.Environment, args ...interface{}) interface{} {
...
func _Date(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 1 {
...
func _DateFromParts(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 3 {
...
func _DateDiff(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 3 {
...
func _DateAdd(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 3 {
...
func _Weekday(env utils.Environment, args ...interface{}) interface{} {
	date, err := _checkOneDateArg(env, "WEEKDAY", args)
	if err != nil {
		return err
	}
...
//
// @function tz(date)
func _TZ(env utils.Environment, args ...interface{}) interface{} {
	date, err := _checkOneDateArg(env, "TZ", args)
	if err != nil {
		return err
	}
...
func _TZOffset(env utils.Environment, args ...interface{}) interface{} {
	date, err := _checkOneDateArg(env, "TZ_OFFSET", args)
	if err != nil {
		return err
	}
...
//
// @function today()
func _Today(env utils.Environment, args ...interface{}) interface{} {
	if len(args) > 0 {
...
func _FromEpoch(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 1 {
...
func _ToEpoch(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 1 {
...
//
// @function now()
func _Now(env utils.Environment, args ...interface{}) interface{} {
	if len(args) > 0 {
...
func _FormatURN(env utils.Environment, args ...interface{}) interface{} {
	if len(args) != 1 {
...
func _checkOneDecimalArg(env utils.Environment, funcName string, args []interface{}) (decimal.Decimal, error) {
	if len(args) != 1 {
...
func _checkOneStringArg(env utils.Environment, funcName string, args []interface{}) (string, error) {
	if len(args) != 1 {
...
func _checkTwoStringArgs(env utils.Environment, funcName string, args []interface{}) (string, string, error) {
	if len(args) != 2 {
...
func _checkOneStringOneIntArg(env utils.Environment, funcName string, args []interface{}) (string, int, error) {
	if len(args) != 2 {
...
func _checkTwoDecimalArgs(env utils.Environment, funcName string, args []interface{}) (decimal.Decimal, decimal.Decimal, error) {
	if len(args) != 2 {
...
func _checkOneDateArg(env utils.Environment, funcName string, args []interface{}) (time.Time, error) {
	if len(args) != 1 {
