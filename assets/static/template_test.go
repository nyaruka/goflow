...
func TestTemplate(t *testing.T) {
	...
	translation := NewTemplateTranslation(channel, envs.Language("eng"), envs.Country("US"), "Hello {{1}}", 1, "0162a7f4_dfe4_4c96_be07_854d5dba3b2b", "external_id")
	...
	assert.Equal(t, "external_id", translation.ExternalID())
	...
	assert.Equal(t, copy.Translations()[0].ExternalID(), template.Translations()[0].ExternalID())
}
